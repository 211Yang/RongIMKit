...
#define kDefaultbubbleTipTextFont [UIFont boldSystemFontOfSize:[UIFont smallSystemFontSize]]
...
#define kbubbleTipTextSideMargin 8.0f
...
- (void)drawRect:(CGRect)rect {
    ...
    if (anyTextToDraw) {
        ...
        //        BOOL colorForOverlayPresent = self.bubbleTipOverlayColor && ![self.bubbleTipOverlayColor
        ...
        //                CGContextSetFillColorWithColor(ctx, self.bubbleTipOverlayColor.CGColor);
        //
        //                CGContextDrawPath(ctx, kCGPathFill);
        //            }
        //            CGContextRestoreGState(ctx);
...
// self.bubbleTipText drawAtPoint:<#(CGPoint)#> withAttributes:<#(NSDictionary *)#>
