...
#else
//    CGSize labelsize = [@"搜索: " boundingRectWithSize:size
...
//    CGSize labelsize = RC_MULTILINE_TEXTSIZE(@"搜索: ", font, size, NSLineBreakByTruncatingTail);
    CGSize labelsize = CGSizeZero;
    if (IOS_FSystenVersion < 7.0) {
        labelsize = RC_MULTILINE_TEXTSIZE_LIOS7(NSLocalizedStringFromTable(@"Search",@"RongCloudKit",nil), font, size, NSLineBreakByTruncatingTail);
    }else {
        labelsize = RC_MULTILINE_TEXTSIZE_GEIOS7(NSLocalizedStringFromTable(@"Search",@"RongCloudKit",nil), font, size);
    }
