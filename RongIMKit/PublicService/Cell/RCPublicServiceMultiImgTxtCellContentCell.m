...
//    CGSize labelsize =
//        [richContent.title boundingRectWithSize:size
...
//    CGSize labelsize = RC_MULTILINE_TEXTSIZE(richContent.title, font, size, NSLineBreakByTruncatingTail);
    CGSize labelsize = CGSizeZero;
    if (IOS_FSystenVersion < 7.0) {
        labelsize = RC_MULTILINE_TEXTSIZE_LIOS7(richContent.title, font, size, NSLineBreakByTruncatingTail);
    }else {
        labelsize = RC_MULTILINE_TEXTSIZE_GEIOS7(richContent.title, font, size);
    }


    //    if (labelsize.height < RCPublicServiceCellContentCellImageHeight) {
