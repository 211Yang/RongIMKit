...
//                                   } context:nil]
//            .size;
//    CGSize labelsize1 = RC_MULTILINE_TEXTSIZE(self.title.text, font1, size, NSLineBreakByTruncatingTail);
    CGSize labelsize1 = CGSizeZero;
    if (IOS_FSystenVersion < 7.0) {
        labelsize1 = RC_MULTILINE_TEXTSIZE_LIOS7(self.title.text, font1, size, NSLineBreakByTruncatingTail);
    }else {
        labelsize1 = RC_MULTILINE_TEXTSIZE_GEIOS7(self.title.text, font1, size);
    }
