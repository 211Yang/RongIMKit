...
//    CGSize labelsize =
//        [content.richConent.title
//            boundingRectWithSize:size
//                         options:NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin |
//                                 NSStringDrawingUsesFontLeading
//                      attributes:@{
//                          NSFontAttributeName : [UIFont systemFontOfSize:RCPublicServiceSingleCellBigFont]
//                      } context:nil]
//            .size;
//    CGSize labelsize = RC_MULTILINE_TEXTSIZE(content.richConent.title, [UIFont systemFontOfSize:RCPublicServiceSingleCellBigFont], size, NSLineBreakByTruncatingTail);
    CGSize labelsize = CGSizeZero;
    if (IOS_FSystenVersion < 7.0) {
        labelsize = RC_MULTILINE_TEXTSIZE_LIOS7(content.richConent.title, [UIFont systemFontOfSize:RCPublicServiceSingleCellBigFont], size, NSLineBreakByTruncatingTail);
    }else {
        labelsize = RC_MULTILINE_TEXTSIZE_GEIOS7(content.richConent.title, [UIFont systemFontOfSize:RCPublicServiceSingleCellBigFont], size);
    }
...
//    CGSize labelsize =
//        [dateString boundingRectWithSize:size
//                                 options:NSStringDrawingTruncatesLastVisibleLine |
//                                         NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading
//                              attributes:@{
//                                  NSFontAttributeName : [UIFont systemFontOfSize:RCPublicServiceSingleCellSmallFont]
//                              } context:nil]
//            .size;
    
//    CGSize labelsize = RC_MULTILINE_TEXTSIZE(dateString, [UIFont systemFontOfSize:RCPublicServiceSingleCellSmallFont], size, NSLineBreakByTruncatingTail);
    CGSize labelsize = CGSizeZero;
    if (IOS_FSystenVersion < 7.0) {
        labelsize = RC_MULTILINE_TEXTSIZE_LIOS7(dateString, [UIFont systemFontOfSize:RCPublicServiceSingleCellSmallFont], size, NSLineBreakByTruncatingTail);
    }else {
        labelsize = RC_MULTILINE_TEXTSIZE_GEIOS7(dateString, [UIFont systemFontOfSize:RCPublicServiceSingleCellSmallFont], size);
    }
...
//                      } context:nil]
//            .size;
//    CGSize labelsize = RC_MULTILINE_TEXTSIZE(content.richConent.digest, [UIFont systemFontOfSize:RCPublicServiceSingleCellSmallFont], size, NSLineBreakByTruncatingTail);
    CGSize labelsize = CGSizeZero;
    if (IOS_FSystenVersion < 7.0) {
        labelsize = RC_MULTILINE_TEXTSIZE_LIOS7(content.richConent.digest, [UIFont systemFontOfSize:RCPublicServiceSingleCellSmallFont], size, NSLineBreakByTruncatingTail);
    }else {
        labelsize = RC_MULTILINE_TEXTSIZE_GEIOS7(content.richConent.digest, [UIFont systemFontOfSize:RCPublicServiceSingleCellSmallFont], size);
    }
...
//    CGSize labelsize =
//        [content boundingRectWithSize:size
//                              options:NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin |
//                                      NSStringDrawingUsesFontLeading
//                           attributes:@{
//                               NSFontAttributeName : [UIFont systemFontOfSize:RCPublicServiceSingleCellSmallFont]
...
//    CGSize labelsize = RC_MULTILINE_TEXTSIZE(content, [UIFont systemFontOfSize:RCPublicServiceSingleCellSmallFont], size, NSLineBreakByTruncatingTail);
    CGSize labelsize = CGSizeZero;
    if (IOS_FSystenVersion < 7.0) {
        labelsize = RC_MULTILINE_TEXTSIZE_LIOS7(content, [UIFont systemFontOfSize:RCPublicServiceSingleCellSmallFont], size, NSLineBreakByTruncatingTail);
    }else {
        labelsize = RC_MULTILINE_TEXTSIZE_GEIOS7(content, [UIFont systemFontOfSize:RCPublicServiceSingleCellSmallFont], size);
    }
...
+ (CGFloat)getCellHeight:(RCMessageModel *)model withWidth:(CGFloat)width {
    ...
    yOffset += RCPublicServiceSingleCellPaddingTop;
    frame = [RCPublicServiceImgTxtMsgCell getTitleFrame:content withWidth:width];
    yOffset += frame.size.height;

    yOffset += RCPublicServiceSingleCellPadding1;
    frame = [RCPublicServiceImgTxtMsgCell getDateFrame:model withWidth:width];
    yOffset += frame.size.height;

    yOffset += RCPublicServiceSingleCellPadding2;
    frame = [RCPublicServiceImgTxtMsgCell getImageFrameWithWidth:width];
    yOffset += frame.size.height;

    yOffset += RCPublicServiceSingleCellPadding3;
    frame = [RCPublicServiceImgTxtMsgCell getContentFrame:content withWidth:width];
    yOffset += frame.size.height;

    yOffset += RCPublicServiceSingleCellPadding4;
    NSString *readAll = NSLocalizedStringFromTable(@"ReadAll",@"RongCloudKit",nil);
    frame = [RCPublicServiceImgTxtMsgCell getReadAllFrame:readAll withWidth:width];
    yOffset += frame.size.height;
