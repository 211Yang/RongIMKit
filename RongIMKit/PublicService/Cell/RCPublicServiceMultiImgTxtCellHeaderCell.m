...
//    CGSize labelsize =
//        [_richContent.title boundingRectWithSize:size
...
//                                      } context:nil]
//            .size;
//    CGSize labelsize = RC_MULTILINE_TEXTSIZE(_richContent.title, font, size, NSLineBreakByTruncatingTail);
    CGSize labelsize = CGSizeZero;
    if (IOS_FSystenVersion < 7.0) {
        labelsize = RC_MULTILINE_TEXTSIZE_LIOS7(_richContent.title, font, size, NSLineBreakByTruncatingTail);
    }else {
        labelsize = RC_MULTILINE_TEXTSIZE_GEIOS7(_richContent.title, font, size);
    }
