...
- (void)setDataModel:(RCMessageModel *)model {
    ...
    if (MessageDirection_RECEIVE == model.messageDirection) {
        ...
        messageContentViewRect.size.width = audioBubbleWidth + 36;
        self.messageContentView.frame = messageContentViewRect;
        self.bubbleBackgroundView.frame = CGRectMake(-8, 0, audioBubbleWidth, 36);
        ...
        self.voiceDurationLabel.frame = CGRectMake(CGRectGetMaxX(self.bubbleBackgroundView.frame)-30, 0, 36, 36);
        ...
        (messageContentViewRect.size.width + 12 + [RCIM sharedRCIM].globalMessagePortraitSize.width + 10)+8;
        self.messageContentView.frame = messageContentViewRect;
    }
}
...
//                                        observer:self];
        ...
        BOOL bPlay = [self.voicePlayer playVoice:[@(self.model.messageId) stringValue] messageReciveStatus:self.model.receivedStatus messageDirection:self.model.messageDirection voiceData:_voiceMessage.wavAudioData observer:self];
