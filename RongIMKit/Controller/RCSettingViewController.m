...
@interface RCSettingViewController () <UIActionSheetDelegate>
@end
...
- (void)viewDidLoad {
    ...
    backText.text = NSLocalizedStringFromTable(@"Back", @"RongCloudKit", nil);    backText.font = [UIFont systemFontOfSize:15];
